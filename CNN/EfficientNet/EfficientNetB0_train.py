...
model.save('EfficientNetB0_model.h5')    # 保存模型
...
ax[0].set_title('EfficientNetB0 Loss')
...
ax[1].set_title('EfficientNetB0 Accuracy')
...
# 保存學習曲線圖片
plt.tight_layout()
plt.savefig("EfficientNetB0_learning_curve.jpg")